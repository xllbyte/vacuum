    ...
    <div class="w-full h-288px">
      <div style="height: 250px">
        <n-card :bordered="false" class="rounded-16px shadow-sm">
          <div id="chart-container" class="h-180px w-380px"></div>
        </n-card>
      </div>
      <div style="margin-top: 3px; height: 14px">
        <n-grid :item-responsive="true" :x-gap="16">
          <n-grid-item span="0:6 640:6 1024:6">
            <div style="height: 100%">
              <span class="py-2px text-7px" style="padding-left: 2px">真空</span>
              <n-button type="primary" size="tiny" style="width: 30px" @click="clickOn">{{ statePV }}</n-button>
              <span class="py-2px text-7px" style="padding-left: 2px">mbar</span>
            </div>
          </n-grid-item>
          <n-grid-item span="0:6 640:6 1024:6">
            <div style="height: 100%">
              <span class="py-2px text-7px" style="padding-left: 2px">真空</span>
              <n-button type="primary" size="tiny" style="width: 30px" @click="clickOnDuring">{{
                duringTime
              }}</n-button>
              <span class="py-2px text-7px" style="padding-left: 2px">秒</span>
            </div>
          </n-grid-item>
          <n-grid-item span="0:6 640:6 1024:6">
            <div style="height: 100%">
              <span class="py-2px text-7px" style="padding-left: 2px">保持</span>
              <n-button class="text-7px" type="primary" size="tiny" style="width: 30px" @click="clickOnHolding">{{
                holdingTime
              }}</n-button>
              <span class="py-2px text-7px" style="padding-left: 2px">秒</span>
            </div>
          ...
          <n-grid-item span="0:6 640:6 1024:6">
            <div style="height: 100%">
              <span class="py-2px text-7px" style="padding-left: 2px">回压</span>
              <n-button type="primary" size="tiny" style="width: 30px" @click="clickOnReback">{{
                rebackTime
              }}</n-button>
              <span class="py-2px text-7px" style="padding-left: 2px">秒</span>
            </div>
