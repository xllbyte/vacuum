...
> = {
  ...
  alarm_navigation: () => import('./alarm/navigation/index.vue'),
  ...
  count_navigation: () => import('./count/navigation/index.vue'),
  ...
  heat_homepage: () => import('./heat/homepage/index.vue'),
  heat_warning: () => import('./heat/warning/index.vue'),
  ipconfig_homepage: () => import('./ipconfig/homepage/index.vue'),
  log_output: () => import('./log/output/index.vue'),
  ...
  nitrogen_navigation: () => import('./nitrogen/navigation/index.vue'),
  parameter_furnace: () => import('./parameter/furnace/index.vue'),
  ...
  product_navigation: () => import('./product/navigation/index.vue'),
  profile_nitrogen: () => import('./profile/nitrogen/index.vue'),
  profile_track: () => import('./profile/track/index.vue'),
  profile_vacuum: () => import('./profile/vacuum/index.vue'),
  system_maintain: () => import('./system/maintain/index.vue'),
  system_navigation: () => import('./system/navigation/index.vue'),
  system_oil: () => import('./system/oil/index.vue'),
  track_navigation: () => import('./track/navigation/index.vue'),
  track_organization: () => import('./track/organization/index.vue'),
  user_accredit: () => import('./user/accredit/index.vue'),
  user_login: () => import('./user/login/index.vue'),
  user_other: () => import('./user/other/index.vue'),
  vacuum_alarm: () => import('./vacuum/alarm/index.vue'),
  vacuum_homepage: () => import('./vacuum/homepage/index.vue'),
  vacuum_surplus: () => import('./vacuum/surplus/index.vue'),
  vacuum_three: () => import('./vacuum/three/index.vue')
};
